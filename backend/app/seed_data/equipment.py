"""Equipment seed fixture. EQX-1xxx/2xxx/3xxx below (40 units) are an exact
...
_ORIGINAL: list[dict] = [
    ...
    {"id": "EQX-1001", "type": "Excavator", "tier": "Heavy", "catalog_id": "CAT-EXC-H",
    ...
    {"id": "EQX-1002", "type": "Crane", "tier": "Mobile Standard", "catalog_id": "CAT-CRN-S",
    ...
    {"id": "EQX-1003", "type": "Bulldozer", "tier": "Heavy", "catalog_id": "CAT-BLD-H",
    ...
    {"id": "EQX-1004", "type": "Excavator", "tier": "Compact", "catalog_id": "CAT-EXC-C",
    ...
    {"id": "EQX-1005", "type": "Bulldozer", "tier": "Heavy", "catalog_id": "CAT-BLD-H",
    ...
    {"id": "EQX-1006", "type": "Grader", "tier": "Standard", "catalog_id": "CAT-GRD-S",
    ...
    {"id": "EQX-1007", "type": "Excavator", "tier": "Heavy", "catalog_id": "CAT-EXC-H",
    ...
    {"id": "EQX-1008", "type": "Excavator", "tier": "Compact", "catalog_id": "CAT-EXC-C",
    ...
    {"id": "EQX-1009", "type": "Grader", "tier": "Standard", "catalog_id": "CAT-GRD-S",
    ...
    {"id": "EQX-1010", "type": "Forklift", "tier": "Standard", "catalog_id": "CAT-FRK-S",
    ...
    {"id": "EQX-1011", "type": "Loader", "tier": "Compact", "catalog_id": "CAT-LDR-C",
    ...
    {"id": "EQX-1012", "type": "Roller", "tier": "Single Drum", "catalog_id": "CAT-RLR-S",
    ...
    # ── active ────────────────────────────────────────────────────────────────
    {"id": "EQX-2001", "type": "Excavator", "tier": "Heavy", "catalog_id": "CAT-EXC-H",
    ...
    {"id": "EQX-2002", "type": "Crane", "tier": "Mobile Standard", "catalog_id": "CAT-CRN-S",
    ...
    {"id": "EQX-2003", "type": "Bulldozer", "tier": "Heavy", "catalog_id": "CAT-BLD-H",
    ...
    {"id": "EQX-2004", "type": "Excavator", "tier": "Compact", "catalog_id": "CAT-EXC-C",
    ...
    {"id": "EQX-2005", "type": "Grader", "tier": "Standard", "catalog_id": "CAT-GRD-S",
    ...
    {"id": "EQX-2006", "type": "Bulldozer", "tier": "Heavy", "catalog_id": "CAT-BLD-H",
    ...
    {"id": "EQX-2007", "type": "Excavator", "tier": "Heavy", "catalog_id": "CAT-EXC-H",
    ...
    {"id": "EQX-2008", "type": "Excavator", "tier": "Heavy", "catalog_id": "CAT-EXC-H",
    ...
    {"id": "EQX-2009", "type": "Excavator", "tier": "Compact", "catalog_id": "CAT-EXC-C",
    ...
    {"id": "EQX-2010", "type": "Excavator", "tier": "Compact", "catalog_id": "CAT-EXC-C",
    ...
    {"id": "EQX-2011", "type": "Bulldozer", "tier": "Heavy", "catalog_id": "CAT-BLD-H",
    ...
    {"id": "EQX-2012", "type": "Bulldozer", "tier": "Compact", "catalog_id": "CAT-BLD-C",
    ...
    {"id": "EQX-2013", "type": "Crane", "tier": "Mobile Standard", "catalog_id": "CAT-CRN-S",
    ...
    {"id": "EQX-2014", "type": "Crane", "tier": "Mini", "catalog_id": "CAT-CRN-M",
    ...
    {"id": "EQX-2015", "type": "Grader", "tier": "Standard", "catalog_id": "CAT-GRD-S",
    ...
    {"id": "EQX-2016", "type": "Forklift", "tier": "Heavy Duty", "catalog_id": "CAT-FRK-H",
    ...
    {"id": "EQX-2017", "type": "Forklift", "tier": "Heavy Duty", "catalog_id": "CAT-FRK-H",
    ...
    {"id": "EQX-2018", "type": "Forklift", "tier": "Standard", "catalog_id": "CAT-FRK-S",
    ...
    {"id": "EQX-2019", "type": "Forklift", "tier": "Standard", "catalog_id": "CAT-FRK-S",
    ...
    {"id": "EQX-2020", "type": "Loader", "tier": "Wheel", "catalog_id": "CAT-LDR-W",
    ...
    {"id": "EQX-2021", "type": "Loader", "tier": "Wheel", "catalog_id": "CAT-LDR-W",
    ...
    {"id": "EQX-2022", "type": "Loader", "tier": "Compact", "catalog_id": "CAT-LDR-C",
    ...
    {"id": "EQX-2023", "type": "Roller", "tier": "Tandem", "catalog_id": "CAT-RLR-T",
    ...
    {"id": "EQX-2024", "type": "Roller", "tier": "Single Drum", "catalog_id": "CAT-RLR-S",
    ...
    # ── maintenance ───────────────────────────────────────────────────────────
    {"id": "EQX-3001", "type": "Bulldozer", "tier": "Heavy", "catalog_id": "CAT-BLD-H",
    ...
    {"id": "EQX-3002", "type": "Crane", "tier": "Mobile Standard", "catalog_id": "CAT-CRN-S",
     "status": "maintenance", "site_id": None, "client_id": None, "operator_id": None,
     "maintenance_note": "500-hour service + boom inspection", "expected_back_on": "2026-08-14",
     "avg_engine_hours_per_day": 0, "avg_idle_hours_per_day": 0},
    {"id": "EQX-3003", "type": "Forklift", "tier": "Heavy Duty", "catalog_id": "CAT-FRK-H",
     "status": "maintenance", "site_id": None, "client_id": None, "operator_id": None,
     "maintenance_note": "Mast chain wear — parts on order", "expected_back_on": "2026-08-18",
     "avg_engine_hours_per_day": 0, "avg_idle_hours_per_day": 0},
    {"id": "EQX-3004", "type": "Roller", "tier": "Tandem", "catalog_id": "CAT-RLR-T",
     "status": "maintenance", "site_id": None, "client_id": None, "operator_id": None,
