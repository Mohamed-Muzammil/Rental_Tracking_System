...
_ORIGINAL = [
    {"id": "INC-101", "equipment_id": "BLD-2003", "type": "geofence_breach",
     "title": "Outside Assigned Site (Geofence Violation)", "severity": "critical",
     "details": "BLD-2003 Heavy Excavator operating 4.2 km outside assigned Summit Mine bounds.",
     "anomaly_score": 92, "status": "active", "created_at": "2026-08-05 14:20"},
    {"id": "INC-102", "equipment_id": "EXC-2007", "type": "excessive_idle",
     "title": "Excessive Engine Idle Hours", "severity": "medium",
     "details": "EXC-2007 Standard Crane logged 6.5h idle time with 1.2h engine runtime.",
     "anomaly_score": 78, "status": "active", "created_at": "2026-08-05 11:45"},
    {"id": "INC-103", "equipment_id": "BLD-2012", "type": "unauthorized_operator",
     "title": "Unauthorized Operator Scan", "severity": "high",
     "details": "Operator ID OP-994 is not cleared for Heavy Duty Bulldozer BLD-2012.",
     "anomaly_score": 88, "status": "active", "created_at": "2026-08-04 16:10"},
    {"id": "INC-104", "equipment_id": "FRK-2019", "type": "service_limit_exceeded",
